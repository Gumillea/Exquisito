...
public class ExquisitoEffects {
    ...
    public static final RegistryObject<MobEffect> EARENDEL = EFFECTS.register("earendel", () -> new BlueprintMobEffect(MobEffectCategory.BENEFICIAL, 0xE6BDE6));
    ...
    public static final RegistryObject<MobEffect> MONKEY_MAJIK = EFFECTS.register("monkey_majik", () -> new WarzipanEffect(MobEffectCategory.BENEFICIAL, 0x895D99));
