...
public class ExquisitoItems {
    ...
    static class ExquisitoFoods {
        ...
        //Cakes
        public static final FoodProperties CHORUS_CAKE = (new FoodProperties.Builder()).nutrition(1).saturationMod(0.1F).effect(() -> new MobEffectInstance(ExquisitoEffects.RESONANCE.get(), 300), 1.0F).build();
        public static final FoodProperties JELLY_RING_CAKE = (new FoodProperties.Builder()).nutrition(1).saturationMod(0.1F).effect(() -> new MobEffectInstance(ExquisitoEffects.FUCHSIA_GOO.get(), 400), 1.0F).build();
        public static final FoodProperties ZURE_BERRY_CAKE = (new FoodProperties.Builder()).nutrition(1).saturationMod(0.1F).effect(() -> new MobEffectInstance(ExquisitoEffects.SPACE_DIVING.get(), 120000), 1.0F).build();
